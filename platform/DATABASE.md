...
## حساب المالك بعد الربط

يُنشأ/يُحدَّث تلقائياً:

- اليوزر: `TuwaiqAdmin`
- الباسورد: `Tuwaiq@Admin26`

الدخول من: `/login?portal=admin` ثم لوحة `/admin`  
من تبويب «آراء الموقع» تقدر تحذف آراء القروب وآراء الأعضاء.
