...
const src = path.join(__dirname, "..", "public", "images", "members", "omar-src.png");
const out = path.join(__dirname, "..", "public", "images", "members", "omar.png");
