...
const src = path.join(__dirname, "..", "public", "images", "members", "mohammed-src.png");
const out = path.join(__dirname, "..", "public", "images", "members", "mohammed.png");
...
(async () => {
  ...
  console.log("mohammed avatar ready");
})().catch((err) => {
  console.error(err);
  process.exit(1);
});
