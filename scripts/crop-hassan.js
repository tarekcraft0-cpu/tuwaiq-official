...
const src = path.join(__dirname, "..", "public", "images", "members", "hassan-src.png");
const out = path.join(__dirname, "..", "public", "images", "members", "hassan.png");
...
(async () => {
  ...
  const inset = Math.round(sizeRaw * 0.06);
  ...
  console.log("hassan avatar ready");
})().catch((err) => {
  console.error(err);
  process.exit(1);
});
