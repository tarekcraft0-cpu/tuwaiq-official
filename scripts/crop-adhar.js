...
const src = path.join(__dirname, "..", "public", "images", "members", "adhar-src.png");
const out = path.join(__dirname, "..", "public", "images", "members", "adhar.png");
...
(async () => {
  ...
  console.log("adhar avatar ready");
})().catch((err) => {
  console.error(err);
  process.exit(1);
});
