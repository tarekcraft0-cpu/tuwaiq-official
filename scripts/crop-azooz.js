...
const src = path.join(__dirname, "..", "public", "images", "members", "azooz-src.png");
const out = path.join(__dirname, "..", "public", "images", "members", "azooz.png");
...
(async () => {
  ...
  console.log("azooz avatar ready");
})().catch((err) => {
  console.error(err);
  process.exit(1);
});
