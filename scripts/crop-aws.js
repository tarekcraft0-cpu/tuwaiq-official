...
const src = path.join(__dirname, "..", "public", "images", "members", "aws-src.png");
const out = path.join(__dirname, "..", "public", "images", "members", "aws.png");
...
(async () => {
  ...
  console.log({ meta: `${meta.width}x${meta.height}`, left, top, size });
